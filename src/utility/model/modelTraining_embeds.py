...
class CNN1D(nn.Module):
    ...
    def __init__(self, embedding_input, num_classes=None, label_column='user', 
        ...
        self.conv1_small = nn.Conv1d(1, 64, kernel_size=3, padding=1)
        self.bn1_small = nn.BatchNorm1d(64)
        
        # Medium-scale features (5-gram)
        self.conv1_medium = nn.Conv1d(1, 64, kernel_size=5, padding=2)
        self.bn1_medium = nn.BatchNorm1d(64)
        
        # Large-scale features (7-gram)
        self.conv1_large = nn.Conv1d(1, 64, kernel_size=7, padding=3)
        self.bn1_large = nn.BatchNorm1d(64)
